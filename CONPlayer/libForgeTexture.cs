...
using System.Linq;
using System.Text;
using cPlayer.Extensions;
using cPlayer.Util;

namespace cPlayer.Texture
{
    internal class TextureConverter
    {
        ...
        private static void DecodeDXT(cPlayer.Texture.Texture.Mipmap m, int[] imageData, bool DXT5)
        {
