...
cPlayerBright\CONPlayer\bin\Debug\

(or `Release` if building Release)

## Step 4: Open Solution
Open `CONPlayer.sln` in Visual Studio.
...
I hope this helps more of you be able to compile and edit cPlayer
